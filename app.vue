<template>
    <div class="__app" ref="app">
        ...
        <!-- Awwwards badge -->
        <div id="awwwards" style="position: fixed; z-index: 999999; transform: translateY(-50%); top: 50%; left: 0">
            <a href="https://www.awwwards.com/sites/der-baukasten" target="_blank"
